...
class SeedSelectSeedView(View):
    ...
    * `flow`: indicates which user flow is in progress during seed selection (e.g.
    ...
    """
    SCAN_SEED = ("시드 스캔하기", SeedSignerIconConstants.QRCODE)
    TYPE_12WORD = ("12 단어 시드 입력", FontAwesomeIconConstants.KEYBOARD)
    TYPE_24WORD = ("24 단어 시드 입력", FontAwesomeIconConstants.KEYBOARD)
...
class LoadSeedView(View):
    SEED_QR = ("SeedQR 스캔", SeedSignerIconConstants.QRCODE)
    TYPE_12WORD = ("12 단어 시드 입력", FontAwesomeIconConstants.KEYBOARD)
    TYPE_24WORD = ("24 단어 시드 입력", FontAwesomeIconConstants.KEYBOARD)
    CREATE = ("새 시드 생성", SeedSignerIconConstants.PLUS)
