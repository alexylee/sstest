...
class WarningScreen(WarningEdgesMixin, LargeIconStatusScreen):
    ...
    status_headline: str = "정보 유출 경고!"     # The colored text under the alert icon

    def __post_init__(self):
        if not self.button_data:
            self.button_data = ["알겠습니다"]
...
class DireWarningScreen(WarningScreen):
    status_headline: str = "중요한 정보!"     # The colored text under the alert icon
